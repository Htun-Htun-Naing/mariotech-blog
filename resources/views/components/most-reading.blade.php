            ...
            <ul class="col-span-12 grid grid-cols-12 gap-6 md:gap-8">
                ...
                @foreach($posts->take(6) as $post)
                    <li class="col-span-12 md:col-span-6 lg:col-span-4 md:space-y-3">
                        <img class="shadow-sm object-cover object-center rounded-xl w-full h-full md:h-48 hidden md:block" src="https://news.cgtn.com/news/2020-11-02/Analysis-China-is-betting-on-science-and-tech-like-never-before-V68V871ula/img/871ca9ce8b9941088260b6ed4ced4eeb/871ca9ce8b9941088260b6ed4ced4eeb.jpeg">
